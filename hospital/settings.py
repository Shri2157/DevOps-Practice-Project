...
#ALLOWED_HOSTS = ['rokadehospital-fbbfhsdecbeuh4fm.canadacentral-01.azurewebsites.net', 'rokadehospital.life']
ALLOWED_HOSTS = [
    'rokadehospital-fbbfhsdecbeuh4fm.canadacentral-01.azurewebsites.net',  # Your Azure domain
    'rokadehospital.life',  # Your custom domain
]
